...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            <form class="form-horizontal" id="addFeatureForm" method="post" action="addcountry.php">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="inputIso2" id="inputIso2" placeholder="Country ISO2" required>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="inputIso3">Country Iso3</label>
                    <div class="controls">
                        <input type="text" name="inputIso3" id="inputIso3" placeholder="Country ISO3" required>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="checkbox">
                            <input type="checkbox" name="countryStatus" id="countryStatus" value="1"> Is Active
                        </label>
