    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            $objCompanyManager = AppMakerFactory::CreateObject("Company");
             $oslist = array();
            if (!empty($_GET['id'])) {
               $objlist = $objCompanyManager->GetCompanyById($_GET['id']);
               $objCompany = $objlist["ObjCompany"];
               $objContact = $objlist["ObjCompanyContact"];
               $oslist = $objCompanyManager->getCompanyoperatingSystem($_GET['id']);
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                try {                   
                    ...
                    header("Location: viewcompany.php?mesg= The Record was updated successfully");
            ...
            <form class="form-horizontal" id="addFeatureForm" method="post" action="editcompany.php">
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="checkbox">
                            <input type="checkbox" name="companySponsored" id="companySponsored" <?php if($objCompany->getCompanyIsSponsored() == '1') { echo 'checked="true"'; }?> value="1"> Activate MemberShip
                        </label>                        
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <label class="checkbox">
                            <input type="checkbox" name="companyStatus" id="countryStatus" <?php if($objCompany->getCompanyStatus() == '1') { echo 'checked="true"'; }?> value="1"> Active Profile
                        </label>
